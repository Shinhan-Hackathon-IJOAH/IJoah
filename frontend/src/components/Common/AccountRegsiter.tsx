  ...
  return (
    ...
    <div className="h-screen grid grid-rows-4">
      <div className="row-span-2 flex flex-col items-center justify-center">
        <Typography variant="h1">계좌 등록하기</Typography>
        ...
        <div className="flex justify-center w-80">
          <Button className="w-full mt-5 text-[14px] bg-[#00c68e]" onClick={AccountSend}>
            내 계좌에 1원 전송
          </Button>
        </div>
      </div>
      {showConfirm && (
        <div className="row-span-1 flex justify-center">
          <div className="text-center flex justify-center flex-col w-screen">
            <div className="text-[16px] font-semibold mb-5">자신의 계좌에 적힌 messege를 입력해 주세요.</div>
            <Input
              className=""
            ...
            />
            <div className="flex justify-center w-80">
              <Button className="w-full mt-5 text-[14px] bg-[#00c68e]" onClick={AccountCofirm}>
                확인하기
              </Button>
            </div>
          </div>
